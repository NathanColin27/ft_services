...
docker build ./srcs/nginx -t ft_nginx_image;
...
docker build ./srcs/phpmyadmin -t ft_phpmyadmin_image;
...
docker build ./srcs/mysql/ -t ft_mysql_image;
...
docker build ./srcs/grafana -t ft_grafana_image;
...
docker build ./srcs/ftps -t ft_ftps_image;
...
docker build ./srcs/influxdb/ -t ft_influxdb_image;
...
docker build ./srcs/wordpress -t ft_wordpress_image;